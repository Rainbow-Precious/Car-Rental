    ...
    <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gray-700 rounded-lg p-4 border border-gray-600">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            <span className="bg-gray-600 text-white px-2 py-1 rounded text-sm">biology</span>
            <span className="bg-gray-600 text-white px-2 py-1 rounded text-sm">grammar</span>
            <span className="bg-gray-600 text-white px-2 py-1 rounded text-sm">essay</span>
          </div>
        ...
        <div className="bg-gray-700 rounded-lg p-4 border border-gray-600">
          ...
          <ul className="space-y-2 mb-4">
            <li className="bg-gray-600 p-2 rounded flex justify-between items-center">
              <span className="text-white">Math Final Exam</span>
              <span className="text-xs bg-gray-500 px-2 py-0.5 rounded">28 questions</span>
            </li>
            <li className="bg-gray-600 p-2 rounded flex justify-between items-center">
              <span className="text-white">Science Quiz</span>
              <span className="text-xs bg-gray-500 px-2 py-0.5 rounded">15 questions</span>
            </li>
            <li className="bg-gray-600 p-2 rounded flex justify-between items-center">
              <span className="text-white">English Homework</span>
              <span className="text-xs bg-gray-500 px-2 py-0.5 rounded">12 questions</span>
            </li>
          </ul>
          <button className="text-yellow-500 hover:text-yellow-400 text-sm font-medium flex items-center">
            <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mt-6 bg-gray-700 rounded-lg p-4 border border-gray-600">
        <h3 className="text-lg font-semibold text-white mb-4 flex items-center">
          ...
          My Subjects and Topics
        </h3>
        <p className="text-gray-400 mb-4">Organize your questions by subject and topic for better organization.</p>
