...
export default function SignInPage() {
  ...
  return (
    ...
    >
      <Grid container sx={{ height: '80vh', maxWidth: 900, boxShadow: 6, borderRadius: 4, overflow: 'hidden' }}>
        ...
        <Grid item xs={12} md={6} sx={{
          ...
          <Paper elevation={0} sx={{ p: 5, maxWidth: 400, width: '100%', borderRadius: 3, boxShadow: 0, bgcolor: 'transparent' }}>
