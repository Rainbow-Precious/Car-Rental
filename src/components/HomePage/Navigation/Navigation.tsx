...
export default function Navigation() {
  return (
    <header className="flex justify-between items-center px-8 py-4 bg-gradient-to-r from-gray-900 to-black border-b border-gray-700 shadow-lg">
      ...
      <nav className="flex gap-8 items-center text-sm">
        ...
        <button className="ml-4 border border-yellow-400 px-5 py-1.5 rounded-full bg-gradient-to-r from-yellow-400 to-yellow-500 text-black font-semibold shadow-md hover:from-yellow-500 hover:to-yellow-600 hover:shadow-lg hover:scale-105 transition-all duration-300">
          Get Started
        </button>
      </nav>
    </header>
