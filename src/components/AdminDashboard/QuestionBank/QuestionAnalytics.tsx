...
const analyticsData = {
  ...
  difficultyDistribution: [
    { difficulty: 'Easy', count: 120, color: 'from-green-500 to-green-600' },
    { difficulty: 'Medium', count: 85, color: 'from-yellow-500 to-yellow-600' },
    { difficulty: 'Hard', count: 40, color: 'from-red-500 to-red-600' },
  ],
  subjectPerformance: [
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-4 rounded-lg text-white">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-2xl font-bold">42s</h3>
        ...
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 p-4 rounded-lg text-white">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-2xl font-bold">12,451</h3>
        ...
        <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
          ...
          <div className="mt-6 pt-6 border-t border-gray-700">
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              ...
              <div className="bg-gray-700 rounded p-3">
                <div className="text-yellow-400 text-xl font-bold">68%</div>
                <div className="text-xs text-gray-400 mt-1">Medium Questions</div>
              </div>
              <div className="bg-gray-700 rounded p-3">
                <div className="text-red-400 text-xl font-bold">45%</div>
      ...
      {/* More Detailed Analytics Button */}
